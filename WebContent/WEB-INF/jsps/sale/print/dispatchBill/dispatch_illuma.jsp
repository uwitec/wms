					...
					<c:if test="${(j.index + 1) % max == 1}">
						...
						<li class="batchPickMsg clearfix">
							<div class="batchPickImg fr">
								...
								<div>批拣单号:${order.batch_pick_sn}</div>
								<%-- <p style="padding:0;margin:0; font-size: 12px; margin: 5px 0 0 0;"><fmt:parseNumber type="number" integerOnly="true" value="${(j.index + 1) / max + 1}" /></p> --%>
						...
						<li class="goodsTabHeader">
							<span style="width: 6%;">序号</span>
							<span style="width: 15%;">商品条码</span>
							<span style="width: 42%;">产品名称</span>
							<span style="width: 9%;">库位</span>
							<span style="width: 9%;">数量</span>
