...
<body>
    <div class="main-container">
        <form method="post" class="lq-form-inline">
            ...
            <div class="lq-form-group">
                <label for="batch_pick">波次单:</label>
                <input type="text" class="lq-form-control" id="batch_pick" name="batch_pick">
            </div>
        </form>

        <div class="lead"  id="employee_no_note"></div>
        <div class="lead" id="batch_pick_note"></div>
    </div>
