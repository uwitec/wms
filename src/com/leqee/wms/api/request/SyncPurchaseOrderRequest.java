...
public class SyncPurchaseOrderRequest extends BaseLeqeeRequest<SyncPurchaseOrderResponse>{
	...
	private String batch_order_sn; //采购批次号，采购需要
	...
	public String getApiMethodName() {
		return METHOD_SYNC_PURCHASE_ORDER_REQUEST;
	}
	...
	@Override
	public Class<SyncPurchaseOrderResponse> getResponseClass() {
		return SyncPurchaseOrderResponse.class;
	}
